...
public class ApiClient {
    ...
    private String basePath = "http://10.0.71.155:8280/complaints/2.0.0";
    ...
    public boolean isSoapMime(String mime) {
        String jsonMime = "(?i)^(application/soap|[^;/ \t]+/[^;/ \t]+[+]xml)[ \t]*(;.*)?$";
        return mime != null && (mime.matches(jsonMime) || mime.equalsIgnoreCase("application/soap+xml"));
    }
    ...
    public RequestBody serialize(Object obj, String contentType) throws ApiException {
        ...
        } else if (isSoapMime(contentType)) {
